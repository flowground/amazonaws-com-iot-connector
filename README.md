# ![LOGO](logo.png) AWS IoT MSP Connector

## Description

A generated MSP connector for the AWS IoT API (version 2015-05-28).
...
flowground :- Telekom iPaaS / amazonaws-com-iot-connector<br/>
